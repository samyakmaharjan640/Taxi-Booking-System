...
from Controller.BookingController import complete_booking
...
class DriverDashboard:
    def __init__(self, root):
        ...
        self.titleLabel = Label(self.root, text="Driver Dashboard", font=("bold",34), bg="dark gray")
        ...
        self.bookButton = Button(self.bodyFrame, font=("bold",14), bg="light gray", text="Complete Ride", command=self.complete)
        ...
        self.driverIdEntry.place(x=1800, y=430, width=150, height=30)
    ...
    def complete(self):
        booking_id = self.bookingIdEntry.get()

        complete = BookingModel(booking_id=booking_id,driver_id=Global.driver_information[0])
        completed =complete_booking(complete)
        if completed:
